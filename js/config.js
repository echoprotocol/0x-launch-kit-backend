...
// Backend will not receive or write any order updates
...
exports.MAKER_FEE_ASSET_DATA = _.isEmpty(process.env.MAKER_FEE_ASSET_DATA)
    ...
    : assertEnvVarType('MAKER_FEE_ASSET_DATA', process.env.MAKER_FEE_UNIT_AMOUNT, EnvVarType.FeeAssetData);
// The taker fee token encoded as asset data
exports.TAKER_FEE_ASSET_DATA = _.isEmpty(process.env.TAKER_FEE_ASSET_DATA)
    ? constants_1.NULL_BYTES
    : assertEnvVarType('TAKER_FEE_ASSET_DATA', process.env.TAKER_FEE_UNIT_AMOUNT, EnvVarType.FeeAssetData);
