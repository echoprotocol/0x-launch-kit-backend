...
var OrderSubmissionDisabledError = /** @class */ (function(_super) {
    __extends(OrderSubmissionDisabledError, _super);
    function OrderSubmissionDisabledError() {
        var _this = (_super !== null && _super.apply(this, arguments)) || this;
        _this.statusCode = 400;
        _this.generalErrorCode = GeneralErrorCodes.OrderSubmissionDisabled;
        return _this;
    }
    return OrderSubmissionDisabledError;
})(RelayerBaseError);
exports.OrderSubmissionDisabledError = OrderSubmissionDisabledError;
