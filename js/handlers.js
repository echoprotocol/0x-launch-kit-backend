            ...
            return __generator(this, function(_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [
                            4 /*yield*/,
                            write_orderbook_1.OrderBook.getAssetPairsAsync(
                                page,
                                perPage,
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        return [
                            4 /*yield*/,
                            write_orderbook_1.OrderBook.getOrderByHashIfExistsAsync(req.params.orderHash),
                        ];
                    case 1:
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        // try {
                        // } catch (err) {
                        //     if ((err as RelayerBaseError).statusCode) {
                        //         throw err;
                        //     } else {
