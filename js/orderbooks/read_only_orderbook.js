...
var ReadOnlyOrderBook = /** @class */ (function() {
    function ReadOnlyOrderBook() {}
    ReadOnlyOrderBook.getOrderByHashIfExistsAsync = function(orderHash) {
    ...
    ReadOnlyOrderBook.getAssetPairsAsync = function(page, perPage, assetDataA, assetDataB) {
        return __awaiter(this, void 0, void 0, function() {
            var connection,
                signedOrderModels,
                assetPairsItems,
    ...
    ReadOnlyOrderBook.prototype.getOrderBookAsync = function(page, perPage, baseAssetData, quoteAssetData) {
        return __awaiter(this, void 0, void 0, function() {
            var connection,
    ...
    // tslint:disable-next-line:prefer-function-over-method
    ReadOnlyOrderBook.prototype.getOrdersAsync = function(page, perPage, ordersFilterParams) {
        return __awaiter(this, void 0, void 0, function() {
            var connection,
    ...
    // tslint:disable-next-line:prefer-function-over-method
    ReadOnlyOrderBook.prototype.addOrderAsync = function(_signedOrder) {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                throw new errors_1.OrderSubmissionDisabledError('Read only orderbook');
            });
        });
    };
    return ReadOnlyOrderBook;
})();
exports.ReadOnlyOrderBook = ReadOnlyOrderBook;
