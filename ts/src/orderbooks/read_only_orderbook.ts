...
import { OrderSubmissionDisabledError } from '../errors';
...
export class ReadOnlyOrderBook {
    ...
    // tslint:disable-next-line:prefer-function-over-method
    public async addOrderAsync(_signedOrder: SignedOrder): Promise<void> {
        throw new OrderSubmissionDisabledError('Read only orderbook');
    }
}
